...
Dials v0.1.1 is designed for `.dials` files generated by **HJU Phonebook V0.8.1 build38**.
...
5. After deployment, open `https://bak2ya.github.io/Dials/`.
...
Dials v0.1.1은 **HJU Phonebook V0.8.1 build38**에서 생성한 `.dials` 파일을 기준으로 제작되었습니다.
...
5. 배포 완료 후 `https://bak2ya.github.io/Dials/`에서 실행합니다.
