...
Dials v0.1.0은 **HJU Phonebook V0.8.1 build38**에서 생성한 `.dials` 파일을 기준으로 제작되었습니다.
...
Dials v0.1.0 is designed for `.dials` files generated by **HJU Phonebook V0.8.1 build38**.
